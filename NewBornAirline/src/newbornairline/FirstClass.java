...
public class FirstClass extends BusinessClass {
    ...
    public FirstClass(String passengerName, String startCity, String destination, String seatNumber, String departureTime, String window, String snack, String wine){
        super(passengerName, startCity, destination, seatNumber, departureTime, window, snack);
        this.wine = wine;
    }
