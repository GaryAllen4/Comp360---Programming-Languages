...
public class EconomyClass {
    ...
    public EconomyClass(String passengerName, String startCity, String destination, String seatNumber, String departureTime, String window){
    ...
    String[] ReserveTicket(String seat, String[] unavailableSeats){
